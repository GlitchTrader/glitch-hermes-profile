    ...
    for book in scenario.get("books", []):
        ...
        trades.append({
            ...
            "entry_plans": [{
                ...
                "change_condition": (
                    row.get("decision_audit", {}).get("change_condition")
                    if isinstance(row.get("decision_audit"), dict) else None
                ),

...
def test_position_prompt_rebases_earned_profit_without_changing_flat_cognition() -> None:
    ...
    for phrase in (
        ...
        "Unknown original risk stays unknown", "Native P&L excursions are sampled",
        "post_entry_bar_excursion", "Bar-implied dollars are not executable profits",
        ...
        "ordinary movement already budgeted by the entry is not new deterioration",
        "EXIT need not await original invalidation", "same decision standard while green and red",
